...
class TurmasController {
    ...
    async create(request, response) {
        ...
        try {
            const { nometurmas, ensino, turno, cargaHoraria, coordenador, qtde_disciplinas, qtde_alunos, data_inicio, data_final } = request.body;
            ...
            const turma = await TurmasModel.create({
                nometurmas, ensino, turno, cargaHoraria, coordenador, qtde_disciplinas, qtde_alunos, data_inicio, data_final
            });
