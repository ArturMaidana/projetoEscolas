    ...
    const generatePDF = async () => {
        try {
            ...
            if (response.data && Array.isArray(response.data)) {
                ...
                doc.text(
                    `Carga Horaria: ${props.turmas.cargaHoraria}`,
                    140,
                    20
                );
    ...
    return (
        <>
                    ...
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={6}>
                            <Typography variant="body1">
                                ...
                                {props.turmas.cargaHoraria}
                            </Typography>
                        </Grid>
                        <Grid item xs={6}>
                            <Typography variant="body1">
                                <strong>Data de Inicio:</strong>{" "}
                                {props.turmas.data_inicio}
                            </Typography>
                        </Grid>
                        <Grid item xs={6}>
                            <Typography variant="body1">
                                <strong>Data Final:</strong>{" "}
                                {props.turmas.data_final}
                            </Typography>
                        </Grid>
                        <Grid item xs={6}>
                            <Typography variant="body1">
            ...
            >
                <Modal.Header>
                    <Modal.Title>
                        Editar Turma: {props.turmas.nometurmas}
                    </Modal.Title>
                </Modal.Header>
                <Form
                    noValidate
                    onSubmit={handleSubmit(editTurma)}
                    validated={!!errors}
                >
                    <Modal.Body>
                        ...
                        <Form.Group>
                            ...
                            <Form.Select
                                {...register("turno")}
                                defaultValue={props.turmas.turno}
                            >
