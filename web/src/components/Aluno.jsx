    ...
    return (
        <>
                    ...
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={6}>
                            <Typography variant="body1">
                                ...
                                {props.alunos.telefone}
                            </Typography>
                        </Grid>
                        <Grid item xs={6}>
                            <Typography variant="body1">
                                <strong>Data de Ingresso:</strong>{" "}
                                {props.alunos.dataIngressante}
                            </Typography>
                        </Grid>
                        <Grid item xs={6}>
                            <Typography variant="body1">
            ...
            >
                <Modal.Header>
                    <Modal.Title>
                        Editar Aluno: {props.alunos.nomealunos}
                    </Modal.Title>
                </Modal.Header>
                <Form
                    noValidate
                    onSubmit={handleSubmit(editAlunos)}
                    validated={!!errors}
                >
                    <Modal.Body>
                        ...
                        <Form.Group>
                            ...
                            <Form.Select
                                {...register("turno")}
                                defaultValue={props.alunos.turno}
                            >
                        ...
                        <Form.Group>
                            ...
                            <Form.Select
                                {...register("turma")}
                                defaultValue={props.alunos.turma}
                            >
                                <option disabled>Clique para selecionar</option>
                                {/* Mapeia as turmas e cria uma opção para cada uma */}
                                {props.turmas.map((turma) => (
                                    <option
                                        key={turma.nometurmas}
                                        value={turma.nometurmas}
                                    >
                                        {turma.nometurmas}
                                    </option>
                                ))}
